...
stockMovementsPage: {
  ...
  warehousesPage: {
    title: 'Gudang',
    subtitle: 'Kelola lokasi gudang, kontak, dan titik penyimpanan aktif.',
    breadcrumbHome: 'Home',
    ...
    summaryWarehouseText: 'Lokasi gudang yang terdaftar',
    summaryActiveText: 'Gudang yang sedang digunakan',
    summaryInactiveText: 'Gudang yang sedang tidak aktif',
    searchPlaceholder: 'Cari gudang berdasarkan nama, kode, atau alamat...',
    allStatus: 'Semua status',
    resultsCount: '{count} gudang ditemukan',
    nameLabel: 'Nama Gudang',
    codeLabel: 'Kode',
    phoneLabel: 'Telepon',
    managerLabel: 'Penanggung Jawab',
    addressLabel: 'Alamat',
    noteLabel: 'Catatan',
    activeLabel: 'Aktif',
    ...
    phonePlaceholder: 'Masukkan telepon gudang',
    managerPlaceholder: 'Masukkan nama penanggung jawab',
    addressPlaceholder: 'Masukkan alamat gudang',
    notePlaceholder: 'Tulis catatan gudang',
    ...
    emptySubtitle: 'Tambahkan gudang baru untuk mulai mengelola stok per lokasi.',
    validationNameRequired: 'Nama gudang wajib diisi.',
    deleteConfirm: 'Hapus gudang ini?',
  },
  ...
  transferStocksPage: {
    ...
    searchPlaceholder: 'Cari berdasarkan produk atau gudang...',
    allStatus: 'Semua status',
    resultsCount: '{count} transfer stok ditemukan',
    statusDraft: 'Draft',
    ...
    validationProductRequired: 'Produk wajib diisi.',
    ...
    validationQuantityInvalid: 'Jumlah harus lebih besar dari 0.',
    deleteConfirm: 'Hapus transfer stok ini?',
  },
