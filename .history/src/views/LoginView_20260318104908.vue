...
.login-page.dark {
  background:
    radial-gradient(circle at top left, rgba(96, 230, 108, 0.16), transparent 28%),
    radial-gradient(circle at bottom right, rgba(5, 152, 20, 0.14), transparent 24%),
...
.mini-card {
  ...
  backdrop-filter: blur(12px);
  box-shadow: 0 20px 40px rgba(5, 152, 20, 0.08);
}
...
.login-card {
  ...
  box-shadow: 0 30px 60px rgba(5, 152, 20, 0.12);
  padding: 32px;
}
