...
<section class="toolbar-card">
          ...
          <table class="data-table">
            ...
            <tbody>
              <tr v-if="filteredUnits.length === 0">
                <td colspan="7" class="empty-cell">No units found.</td>
              </tr>
  ...
  const appliedSortBy = ref<'newest' | 'oldest' | 'az' | 'za'>('newest')
  ...
  const filteredUnits = computed(() => {
    ...
    if (appliedSortBy.value === 'newest') {
      results.sort((a, b) => b.id - a.id)
    } else if (appliedSortBy.value === 'oldest') {
      results.sort((a, b) => a.id - b.id)
    } else if (appliedSortBy.value === 'az') {
      results.sort((a, b) => a.name.localeCompare(b.name))
    } else if (appliedSortBy.value === 'za') {
