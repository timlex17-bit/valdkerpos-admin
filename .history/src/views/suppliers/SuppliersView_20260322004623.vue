<template>
              ...
              <tr v-for="supplier in filteredSuppliers" :key="supplier.id">
                ...
                <td class="text-right">
                  <div class="row-actions">
                    ...
                    <button class="btn btn-sm btn-danger" @click="removeSupplier(supplier.id)">
                      Delete
                    </button>
                  </div>
                </td>
  ...
  const suppliers = ref<Supplier[]>([
    {
      id: 5,
      name: 'Rymond Unipessoal',
      contact_person: 'Rymond',
      cell: '+6707754613128',
      email: 'rymond@example.com',
      address: 'Dili, Timor-Leste',
    },
    {
      id: 4,
      name: 'Wellys Unipessoal',
      contact_person: 'Wellys',
      cell: '+6707756431216',
      email: 'wellys@example.com',
      address: 'Becora, Dili',
    },
    {
      id: 3,
      name: 'Leader Unipessoal',
    ...
    },
    {
      id: 2,
      name: 'Wfour Store',
      contact_person: 'Store Admin',
      cell: '+67077542431',
      email: 'wfour@example.com',
      address: 'Manleuana, Dili',
    },
    {
      id: 1,
      name: 'Perisos Unipessoal',
      contact_person: 'Perisos',
      cell: '+67077154246',
      email: 'perisos@example.com',
