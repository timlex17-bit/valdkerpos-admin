...
import AppSidebar from '../fragment/AppSidebar.vue'
import AppTopbar from '../fragment/AppTopbar.vue'
...
const openGroups = ref<OpenGroups>({
  sales: true,
  inventory: true,
  people: true,
  finance: true,
...
const selectedShopId = ref<string>('1')
